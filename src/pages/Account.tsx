...
import { Camera, Globe, Clock, ChevronDown, AlertCircle, CheckCircle2, Lock, X, Pencil, Search } from 'lucide-react';
...
export default function AccountPage() {
  ...
  return (
    <div className="h-screen flex overflow-hidden bg-background">
      {!isMobile && <Sidebar activeTab="account" onTabChange={(id) => {
      ...
      <div className="flex-1 flex flex-col min-w-0">
        {/* Top tabs bar */}
        <div className="flex flex-col md:flex-row md:items-center md:justify-between border-b border-border bg-card px-3 md:px-6">
          ...
          <div className="hidden md:flex items-center gap-6 text-sm">
            <div className="flex items-center gap-2">
              <span className="text-muted-foreground">My current currency</span>
            ...
            <div className="text-right">
              ...
              <div className="font-bold text-foreground">{balance > 0 ? `${balance.toFixed(2)}$` : '0.00$'}</div>
            </div>
            <div className="text-right">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[1fr_1fr_1fr_280px] gap-6 md:gap-8">
              ...
              >
                ...
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-1 mt-0.5">
                      <span className="bg-danger/20 text-danger text-[9px] font-bold px-2 py-0.5 rounded flex items-center gap-1">
                ...
                <div className="space-y-4">
                            ...
                            {filteredCountries.map(c => (
                              <button
                                ...
                                className={`w-full flex items-center gap-3 px-3 py-2.5 text-sm hover:bg-accent transition-colors text-left ${
                                  country === c.name ? 'bg-accent text-primary' : 'text-foreground'
                                }`}
                              >
                  ...
                  <button className="w-full bg-primary hover:bg-primary/90 text-primary-foreground font-bold py-3 rounded-lg transition-colors text-sm">
                    Save
                  </button>
                </div>
              </motion.div>
                ...
                <div className="space-y-5">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-muted-foreground flex items-center gap-1">
                        Receiving codes via Email <Pencil size={10} className="text-primary cursor-pointer" />
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-sm text-foreground">To enter the platform</span>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-sm text-foreground">To withdraw funds</span>
                    </div>
                  </div>
              ...
              >
                ...
                <button className="flex items-center gap-2 text-danger hover:text-danger/80 text-sm mt-4 transition-colors">
                  <X size={14} />
                  Delete My account
                </button>
              </motion.div>
